...
public class RefreshToken extends TableImpl<RefreshTokenRecord> {
     ...
     */
    public final TableField<RefreshTokenRecord, String> TOKEN = createField(DSL.name("token"), SQLDataType.VARCHAR(500).nullable(false), this, "");
     ...
     */
    public final TableField<RefreshTokenRecord, OffsetDateTime> EXPIRY_DATE = createField(DSL.name("expiry_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    /**
     * The column <code>public.refresh_token.created_date</code>.
     */
    public final TableField<RefreshTokenRecord, OffsetDateTime> CREATED_DATE = createField(DSL.name("created_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    /**
     * The column <code>public.refresh_token.last_modified_date</code>.
     */
    public final TableField<RefreshTokenRecord, OffsetDateTime> LAST_MODIFIED_DATE = createField(DSL.name("last_modified_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    /**
     * The column <code>public.refresh_token.version</code>.
     */
    public final TableField<RefreshTokenRecord, Integer> VERSION = createField(DSL.name("version"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_REFRESH_TOKEN_TOKEN, Indexes.IDX_REFRESH_TOKEN_USER_ID);
    }
    ...
    public List<ForeignKey<RefreshTokenRecord, ?>> getReferences() {
        return Arrays.asList(Keys.REFRESH_TOKEN__FK_REFRESH_TOKEN_USER);
    }
    ...
    public AppUserPath appUser() {
        if (_appUser == null)
            _appUser = new AppUserPath(this, Keys.REFRESH_TOKEN__FK_REFRESH_TOKEN_USER, null);
